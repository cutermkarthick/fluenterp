							...
							<table width=100% border=0 cellpadding=6 cellspacing=0  >
								...
								<table width=100% border=0 cellpadding=4 cellspacing=1 bgcolor="#DFDEDF" class="stdtable1">
									<tr>
				   					 ...
				   					 <tr>
										<td bgcolor="#FFFFFF"><span class="tabletext"><select name="sem" size="1" width="50">
											<?php if($select=='role'){?>
             											<option selected>role
             											<option value>lname<?php }else {?>
										...
										<td bgcolor="#FFFFFF"><input type="text" name="semp" size=20 value="<?php echo "$emp_match";?>" onkeypress="javascript: return checkenter(event)"></td>
										...
										<td bgcolor="#FFFFFF" colspan=3><span class="tabletext"><select name="sort1" size="1" width="100">
											<?php if($select1=='lname'){?>
             											<option selected>lname
             											<option value>empid<?php }else {?>
             											<option selected>empid
             											<option value>lname<?php }?>
            											</select>
       											<input type="hidden" name="semprl">
     											<input type="hidden" name="emp_oper">
                              ...
                              <thead>
												...
												$result = $newEmp->getEmps4sa($cond,$sort1,$offset,$rowsPerPage);
     												while ($myrow = mysql_fetch_row($result)) {
	      											printf('<tr><td bgcolor="#FFFFFF"><span class="tabletext"><a href="edit_emp.php?empid=%s"><b>%s</b></td>
