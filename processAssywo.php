...
// $usiteid = $assywo->getsiteid4user($user);
...
if($bom_type1 == 'Non Assembly')
{
         if($crn_type1  == 'Untreated')
          ...
          //$assywo_li->updateqtyused_assy($qtyused_assy1);
          if($bom_type1  == 'Bought Out')
           {
              $wogrnqty = $assywo_li->getgrnwoqty($grn1);
              $wousdqty=$wogrnqty+$qty_wo1;
...
/*
      if($bom_type1 =='Manufactured')
      {
       $checkqanc=$assywo_li->getnc_qa($grn1);
       if($checkqanc != '' && trim($qty_rej1) <= 0 && trim($qty_rew1) <= 0  && ($nc_num1 =='' || $nc_num1 =='0') )
        {
             echo "<table border=1><tr><td><font color=#FF0000>";
             die("An NC Exists For The WO #:".$grn1."" );
             echo "</td></tr></table>";
        }


        else if ($checkqanc == '' && (trim($qty_rej1) > 0 || trim($qty_rew1) >0))
      {
             echo "<table border=1><tr><td><font color=#FF0000>";
             die("No NC exists for WO: $grn1");
             echo "</td></tr></table>";
      ...
      if($bom_type1 =='Sub Assembly')
      {
       $checkqanc1=$assywo_li->getnc_qa_sa($grn1);
       if($checkqanc1 != '' && trim($qty_rej1) <= 0 && trim($qty_rew1) <= 0  && ($nc_num1 =='' || $nc_num1 =='0') )
        {
             echo "<table border=1><tr><td><font color=#FF0000>";
             die("An NC Exists For The AssyWO #:".$grn1."" );
             echo "</td></tr></table>";
        }


        else if ($checkqanc1 == '' && (trim($qty_rej1) > 0 || trim($qty_rew1) >0))
      {
             echo "<table border=1><tr><td><font color=#FF0000>";
             die("No NC exists for AssyWO: $grn1");
             echo "</td></tr></table>";
...
if($bom_type1 == 'Non Assembly')
{
    if($crn_type1  == 'Untreated')
      ...
      {
       $retqty = $totqty4wo1 - $prev_qty_ret1 + $qty_ret1  ;
       // echo $retqty . " " . $totqty4wo1 . " " .$prev_qty_ret1 ." ".$qty_ret1;
