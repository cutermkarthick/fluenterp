...
<html>
<head>
<title>PRN Outlook</title>
</head>
<body leftmargin="0" topmargin="0" marginwidth="0">

<form action='prnoutlook.php' method='post' enctype='multipart/form-data'>
<?php
...
<tr>
<td valign='top'><span class="pageheading"><b>Mfg Outlook - Demand vs Actual</b></td>
<td colspan=160>&nbsp;</td>
</tr>
</table>
...
<tr bgcolor="#F5F6F5">
<td align="left" colspan=7 style="padding-left:500px;"><span class="heading"><b>Search Criteria</b></td></tr>
<tr>
...
<br>
<!--<img src="images/export.gif" onclick="export_crn();" >-->
<br>
...
<table align="top"  border=0 cellpadding=3 cellspacing=1 bgcolor="#FFFFFF">
<!-- <tr bgcolor="#FFFFFF">
<td><span class="tabletext">
  <a href="export_prnoutlook.php?crn=<?php echo $crn;?>&ftrigger=<?php echo $ftrigger; ?>">Export To Excel</td>
</tr>
 --></table>
...
foreach ($schweekarr as $date1) 
{
	...
	if ($ft == 0)
	{
       $schdate1=date("M j, Y",$x);
	    ...
	    echo "<td align=\"center\" width=\"200px\" bgcolor=\"#00DDFF\" align=\"left\"><span class=\"labeltext\" ><b>WW starting<br> $schdate1<br>(Potential Backlog)</b></td>";
    }
	else
	{
       $schdate1=date("M j, Y",$x);
	    echo "<td align=\"center\" width=\"200px\" bgcolor=\"#00DDFF\" align=\"left\"><span class=\"labeltext\" ><b>WW starting<br> $schdate1</b></td>";
    }
	$ft = 1;
}
	$i = 0;
...
printf('
     <td bgcolor="#FFFFFF" align="center" width="100px"><span class="labeltext"><b>%d</b></td>
     <td bgcolor="#FFFFFF" align="center" width="100px"><span class="labeltext"><b>%d</b></td>
     <td bgcolor="#FFFFFF" align="center" width="100px"><span class="labeltext"><b>%d</b></td>
	 <td bgcolor="#FFFFFF" align="center" width="100px"><span class="labeltext"><b>%d</b></td>
	  <td bgcolor="#FFFFFF" align="center" width="100px"><span class="labeltext"><b>%s</b></td>
   ','','','',$grnbbal,$crntype);
...
printf('
		 ...
		 <td bgcolor="#FFFFFF" align="center" width="100px"><span class="labeltext"><b>%s</b></td>
		 <td bgcolor="#FFFFFF" align="center" width="100px"><span class="labeltext"><b>%d</b></td>
		  <td bgcolor="#FFFFFF" align="center" width="100px"><span class="labeltext">%s<b></b></td>
...
foreach ($crnarr[$crn] as $date => $qtyreq) 
{
	...
	if ($qtyreq != 0)
	{
	   ...
	   {
		  $equation=$wip . "wip";
		  $disparr[$date] =  " bgcolor=\"#FFFF00\"><span class=\"labeltext\">$qtyreq<br>($equation)";
	      $wip = $wip- $qtyreq;
	   }
	  ...
	  else if ($qtyreq < $wip)
	   {
    		...
    		$equation=$qtyreq . "wip";
			$disparr[$date] =  " bgcolor=\"#00FF00\"><span class=\"labeltext\">$qtyreq<br>($equation)";
	        $wip = $wip - $qtyreq;
	    }
	   // if ($qtyreq == $fg + $wip)
	   // {
...
// Added code to check if qty used from grn; if so need WO create trigger
		  ...
		  if ($grn2mfrdate <= $date) 
		  {
		   ...
		   {
			  $disparr[$date] =  " bgcolor=\"#FFA500\"><span class=\"labeltext\">$qtyreq<br>($equation)";
	 ...
	 else  if ($qtyreq < ($wip+$fg+$grn+$poarray[0]))
      {
		    ...
		    if ($currmnth < $date)			   
		    {
				  $disparr[$date] =  " bgcolor=\"#FF0000\"><span class=\"labeltext\">$qtyreq<br>($equation)";
...
// Added code to check if qty used from grn; if so need WO create trigger
			...
			if ($currmnthplus9 < $date)			   
		    {
			   ...
			   {
                  $disparr[$date] =  " bgcolor=\"#FF0000\"  width=\"200px\"><span class=\"labeltext\">$qtyreq<br>($equation)";
			   }
					  $fg=0;
					  $grn=0;
					  $wip=0;
...
// Added code to check if qty used from grn; if so need WO create trigger
      ...
      else
	  {
		   ...
		   $disparr[$date] = " bgcolor=\"#FF0000\"><span class=\"labeltext\">$qtyreq($shortfall)<br>($equation)";
		   $wip=0;
		   $fg = 0;
		   $grn = 0;
		   $poqtysum=0;
...
// Check for WO Treatment trigger
  ...
  if ($ftrigger == 'ALL' or $ftrigger == 'RMPO' or
   ...
   printf('
		 <td align="center" width="100px"><span class="labeltext"><b>%d<br>%s</b></td>	
	     <td align="center" width="100px"><span class="labeltext"><b>%d<br>%s</b></td>
		 <td align="center" width="100px"><span class="labeltext"><b>%d<br>%s</b></td>
		 <td align="center" width="100px"><span class="labeltext"><b>%d<br>%s</b></td>
	     <td align="center" width="100px"><span class="labeltext"><b>%d<br>%s</b></td>
