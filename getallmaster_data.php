...
<table width="100%" border=0 cellpadding=3 cellspacing=1 bgcolor="#DFDEDF" >
       <tr  bgcolor="#FFCC00">
            ...
            <td width=25% bgcolor="#EEEFEE"><span class="tabletext"><b>Partnum</b></td>

           <td width=10% bgcolor="#EEEFEE"><span class="tabletext"><b>Dim1</b></td>
           <td width=10% bgcolor="#EEEFEE"><span class="tabletext"><b>Dim2</b></td>
           <td width=10% bgcolor="#EEEFEE"><span class="tabletext"><b>Dim3</b></td>       </tr>
           </table>
           <div style="width:100%; height:200; overflow:auto;border:">
<table width="100%" border=0 cellpadding=3 cellspacing=1 bgcolor="#DFDEDF" >
<?php
