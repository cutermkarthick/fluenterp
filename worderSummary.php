...
<?php
      ...
      else if ($sval == 'WO Cancelled')
      {
?>
	<option selected value="WO Cancelled">WO Cancelled
	<option value="Cancelled">Cancelled
	<option value="Open">Open
	<option value="All">All
        <option value="Closed">Closed
...
<td bgcolor="#FFFFFF" colspan="1"><span class="labeltext"><b>Sort on</b>
...
<div class="contenttitle radiusbottom0">
  <h2 class="table"><span>List of Work Orders - (Red highlighted are Flagged WOs) 

<?php
if ($dept == 'PPC' || $dept == 'Sales'||$dept == 'PPC4'||$dept == 'PPC5')
{
?>
<input type="button" class="stdbtn btn_blue" style="float:right;padding:2px;margin-right:5px;" onClick="location.href='WodetailsEntry.php'" value="New" > 
<!-- <a href ="WodetailsEntry.php"><img name="Image8" border="0" style="float:right" src="images/new.gif"></a> -->
<?php
}
?>
</h2>
...
<thead>
<tr>
<th class='head0'><b>WO</b></th>
<th class='head1'><b>Company</b></th>
<th class='head0'><b>Cust PO</b></th>
<th class='head1'><b>PRN#</b></th>
<th class='head0'><b>Book Date</b></th>
<th class='head1'><b>WO Qty</b></th>
<th class='head0'><b>Amnd Qty</b></th>
<th class='head1'><b>GRN#</b></th>
<th class='head0'><b>Status</b></th>
<th class='head1'><b>Sch Due</b></th>
<th class='head0'><b>Rev. Comp</b></th>
<th class='head1'><b>Date Code</b></th>
<th class='head0'><b>WO Type</b></th>
<th class='head1'><b>FAI</b></th>
</tr>
</thead>
<tbody>
<?php
...
$userrole=$_SESSION['userrole'];
  ...
  $result = $newworkOrder->getWorkOrders($username,$userid,$siteid,$usertype,$userrole,$cond,$sort1,$sort2,$offset,$rowsPerPage);
...
// Dec 30, 05
     ...
     if($myrow[0] != ''&& $myrow[0] != 'NULL')
	  ...
	  $edate = $myrow[33];
if($edate !='0000-00-00' && $edate  !=''  && $edate != 'null')
{
      $today = date("Y-m-d"); 
     // echo "Today is $today<br>";
	  ...
	  $highlight = "#FFFFFF";
       ...
       if ($myrow[15] == '0000-00-00' || $myrow[15] == '' || $myrow[15] == 'null' || $myrow[5] == 'Open')
       {
            if ($myrow[32] == 'With Treatment' && $diff > 112)
	    {
              $highlight = "#FF0000";
	    }
            if ($myrow[32] != 'With Treatment' && $diff > 84)
	    {
              $highlight = "#FF0000";
	    }
	}
           ...
           if ($flag == 0)
            {
   	       ...
   	       printf('<tr><td bgcolor="#FFFFFF" align="center"><span class="tabletext">
                           <a href="woDetails.php?typenum=%s&wotype=%s&worecnum=%s&wonum=%s">%05d%s</td>
                      ',
		         $myrow[7],$myrow[1],$myrow[11],$myrow[0],$myrow[0],$wonum_suf
                     );
               $flag = 1;
?>
               <td bgcolor="<?php echo $highlight ?>" align="center"><span class="tabletext"><?php echo $myrow[2] ?></td>
               
               <td bgcolor="#FFFFFF" align="center"><span class="tabletext"><?php echo $myrow[3] ?></td>
               <td bgcolor="#FFFFFF" align="center"><span class="tabletext"><?php echo $myrow[28] ?></td>
              
               <td bgcolor="#FFFFFF" align="center"><span class="tabletext"><?php echo $myrow[16] ?></td>
    <?php
         /*
           if($myrow[20]!=null){
   ...
   ?>
       <td bgcolor="#FFFFFF" align="center"><span class="tabletext"><?php echo $woqty ?></td>
       <td bgcolor="#FFFFFF" align="center"><span class="tabletext"><?php echo $amndqty ?></td>
       <td bgcolor="#FFFFFF" align="center"><span class="tabletext"><?php echo $myrow[27] ?></td>
...
<?php
	   ...
	   // End additions
?>
               <td bgcolor="#FFFFFF" align="center"><span class="tabletext"><?php echo $myrow[5] ?></td>
               <td bgcolor="#FFFFFF" align="center"><span class="tabletext"><?php if ($myrow[14] != '00-00-00') echo $myrow[14] ?></td>
               <td bgcolor="#FFFFFF" align="center"><span class="tabletext"><?php if ($myrow[17] != '00-00-00') echo $myrow[17] ?></td>
               <td bgcolor="#FFFFFF" align="center"><span class="tabletext"><?php if ($myrow[15] != '00-00-00') echo $myrow[15] ?></td>
               <td bgcolor="#FFFFFF" align="center"><span class="tabletext"><?php echo $myrow[29] ?></td>
               
               <td bgcolor="#FFFFFF" align="center"><span class="tabletext"><?php echo $myrow[31] ?></td></tr>
...
<?php
             ...
             else
             {
                ...
                printf('<tr bgcolor="#EEEEEE"><td align="center"><span class="tabletext"><a href="woDetails.php?typenum=%s&wotype=%s&worecnum=%s&wonum=%s">%05d%s</td>
                      ',
		         $myrow[7],$myrow[1],$myrow[11],$myrow[0],$myrow[0],$wonum_suf
                     );
...
?>
                ...
                <td align="center"><span class="tabletext"><?php echo $myrow[3] ?></td>
                <td align="center"><span class="tabletext"><?php echo $myrow[28] ?></td>
              
                <td align="center"><span class="tabletext"><?php echo $myrow[16] ?></td>
    ...
    ?>
           <td bgcolor="#FFFFFF" align="center"><span class="tabletext"><?php echo $woqty ?></td>
          <td bgcolor="#FFFFFF" align="center"><span class="tabletext"><?php echo $amndqty ?></td>
           <td align="center"><span class="tabletext"><?php echo $myrow[27] ?></td>
...
?>
               ...
               <td align="center"><span class="tabletext"><?php echo $myrow[5] ?></td>
               <td align="center"><span class="tabletext"><?php if ($myrow[14] != '00-00-00') echo $myrow[14] ?></td>
               <td align="center"><span class="tabletext"><?php if ($myrow[17] != '00-00-00') echo $myrow[17] ?></td>
               <td align="center"><span class="tabletext"><?php if ($myrow[15] != '00-00-00') echo $myrow[15] ?></td>
               <td align="center"><span class="tabletext"><?php echo $myrow[29] ?></td>
              
               <td align="center"><span class="tabletext"><?php echo $myrow[31] ?></td></tr>
...
<?php
	  ...
	  // multiple file attachments added on 25 Jan 2007  */
             $result1 = $newworkOrder->getAttachedfile($myrow[11]);
	            while ( $myrow1 = mysql_fetch_row($result1)) {
                        printf('<td bgcolor="#EFEFEF" align="center" ><span class="heading"><a href=%s>%s</a></td>',
		                $myrow1[1],$myrow1[1]);
                  }
	   // End additions
?>
