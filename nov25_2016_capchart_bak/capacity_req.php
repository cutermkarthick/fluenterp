...
$to=$_REQUEST['pl_year'];
$crn = $_REQUEST['crnnum'];
// $start_date = $to."-".$frm."-"."01";
$st_date1 = $to."-".$frm."-"."01";
$ed_date = date("Y-m-t", strtotime($st_date1));
$crnnum = $_REQUEST['crnnum'];
$mc=($_REQUEST['mc_series'] == '')?'all':$_REQUEST['mc_series'];
                ...
                <td bgcolor="#FFFFFF">
                    <table width=100% border=0 cellpadding=6 cellspacing=0>
                        ...
                        <tr>
                                ...
                                <table width=100% border=0 cellpadding=3 cellspacing=1 bgcolor="#DFDEDF" class="stdtable1">
                                    ...
                                    <table width=100% border=0 cellpadding=3 cellspacing=1 bgcolor="#DFDEDF" class="stdtable1">
                                        <tr bgcolor="#FFFFFF">
                                            ...
                                            <td><span class="tabletext"><input type="text" name="crnnum" id='crnnum' size=10 value="<?php echo $_REQUEST['crnnum']?>"></span></td>

                                            <td  bgcolor="#FFFFFF" width='40%'><span class="labeltext"><b>From &nbsp&nbsp</b></span>
                                                ...
                                                <span class="labeltext"><b>&nbsp;&nbsp;To</b></span>
                            ...
                            $numrows = mysql_num_rows($crnmcschresult);

                            if (!isset($_REQUEST['mc_series']) || ($numrows == 0)) 
                            { ?>
                                ...
                                <tr>
                                    <td>
                                        <table width=80% border=0 cellpadding=3 cellspacing=1 bgcolor="#DFDEDF" class="stdtable1">
                                            <tr bgcolor="#FFCC00">
                                                <td bgcolor="#EEEFEE" width='10px'><span class="tabletext"><b>Avail. <br/>M/C<br/> Strokes</b></span></td>
                                                ...
                                                <td bgcolor="#33cc99" width='20px'><span class="tabletext"><b>Start<br/> Date&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</b></span></td>
                                                ...
                                                <td bgcolor="#33cc99" width='10px'><span class="tabletext"><b>Req<br/> PRN<br/> Strokes.</b></span></td>
                                                <td bgcolor="#33cc99" width='10px'><span class="tabletext"><b>Balance<br/>PRNs<br/> Strokes.</b></span></td>
                                                <td bgcolor="#33cc99" width='10px'><span class="tabletext"><b>Balance<br/>PRN<br/> Qty</b></span></td>
                                                <td bgcolor="#EEEFEE" width='10px'><span class="tabletext"><b>Balance<br/> M/C<br/> Strokes.</b></span></td>
                            ...
                            else
                            {
                                ...
                                $mccapresult = $newmc_capacity->getmc_capacity($mc,$month,$year);
                               ...
                               // print_r($mccapmaster);
                                ...
                                while($mycrnmcschrow=mysql_fetch_row($crnmcschresult))
                                {
                                    ...
                                    $mc_id = $mycrnmcschrow[8];
                                    $mc_sr = $mycrnmcschrow[9];


                                    $mc_avail_hrs = $mccapmaster[$mc_name];
                                    $avail_capacity = $mccapmaster[$mc_name];
                                    ...
                                    $req_crn_hrs=floor($runtime_hrs*$crn_qty);
                                    ...
                                    if($runtime_hrs>0)
                                    {
                                      $possible_qty=floor($avail_capacity/$runtime_hrs);
                                    }
                                    else
                                    {
                                      $possible_qty=0;
                                    ...
                                    if($avail_capacity >= $runtime_hrs)
                                    {
                                        ...
                                        if($possible_qty > $crn_qty)
                                        {
                                            ...
                                            if($crn_qty !='' && $crn_qty!='0')
                                              $balance_mc_hrs=abs($avail_capacity-($crn_qty*$runtime_hrs));
                                            else
                                        ...
                                        {       
                                            ...
                                            if($crn_qty !='' && $crn_qty !='0')
                                                $balance_mc_hrs=abs($avail_capacity-($possible_qty*$runtime_hrs));
                                            else
                                                $balance_mc_hrs=$avail_capacity;

                                            $balance_crn_hrs=abs($req_crn_hrs-($possible_qty*$runtime_hrs));  
                                    ...
                                    {       
                                        ...
                                        $end_time2=$_REQUEST[$end_time1];    
                                        $start_meridiem=substr($time,-2);
                                        $end_meridiem=substr($end_time,-2);
                                        ...
                                        $newmc_capacity->setend_time($end_time2);
                                    ...
                                    if ($crnarr[$crn] > 0) 
                                    {
                                        ...
                                        {  
                                            ...
                                            echo "<table style='width:100%'><tr><td align=\"center\" colspan=16 bgcolor=\"#00DDFF\" style=\"padding:5px;\"><center><span class=\"heading\"><b>M/C Name: ". $mc_name . ",  Avail Capacity: ".$mccapmaster[$mc_name]."</b></span></center></td></tr></table>";
                                        ...
                                        if($prev_crn != $crn || $prev_mc != $myrow_mc['mc_name'] || $prev_mc =='')
                                        {   
                                        ...
                                        echo "<td bgcolor=\"#FFFFFF\" width=\"10px\"><span class=\"tabletext\">
                                              <div id=\"status$i\"><ul>";
                                        ...
                                        if ($crn == "") 
                                        {
                                           echo "<li style=\"color: white\" size=5 type=square></li>" ;
                                        }
                                        elseif($crn_qty == $balance_crn_qty)
                                        {
                                            echo "<li style=\"color: red\" size=5 type=square></li>" ;
                                        }
                                        elseif($balance_crn_qty == 0)
                                        {
                                            echo "<li style=\"color: green;width:50%\" size=5 type=square></li>" ;
                                        }
                                        elseif($crn_qty-$balance_crn_qty >0)
                                        {
                                            echo "<li style=\"color: orange\" size=5 type=square></li>" ;
                                        }
                                        ...
                                        echo "<td bgcolor=\"#FFFFFF\"><span class=\"tabletext\"><input type=\"text\" size=2  name=\"priority$i\" id=\"priority$i\"   value=\"$priority\"  ></span></td>";
                                        ...
                                        echo "<td bgcolor=\"#FFFFFF\"  width=\"10px\"><span class=\"tabletext\"><input type=\"text\" size=4  name=\"end_time$i\" id=\"end_time$i\" value=\"$end_time\" style=\"background-color:#DDDDDD;\" readonly=\"readonly\"></span></td>";
