...
<tr>
<td>
<table width=100% border=0 cellpadding=3 cellspacing=1 bgcolor="#DFDEDF" class="stdtabl1" >
<tr bgcolor="#DDDEDD">
...
<tr bgcolor="#FFFFFF">
<td><span class="labeltext">M/C Series</p></font></td>
...
<td align="center" ><span class="labeltext">
<button class="stdbtn btn_blue" style="float:center;padding:2px;margin-right:2px;" onclick="javascript: return fetch_cap_req()" >Get</button>
...
if($mc_series!= 'select' && $start_date!='' && $end_date!='')
{
  ...
  if($end_month < 10)
    ...
    ?>    
        <table border=0 bgcolor="#DFDFDF" width=50%  cellspacing=2 cellpadding=3 height='150'>
    <tr bgcolor='#FFFFFF'>
    <td >
    <div id="my_chart<?echo preg_replace('/\s/', '',$row_series[0]) ?>">
    </div>
    <script type="text/javascript" src="scripts/swfobject.js"></script>
    <script type="text/javascript">
    swfobject.embedSWF(
    "open-flash-chart1.swf", "my_chart<? echo preg_replace('/\s/', '',$row_series[0])?>",
    <?=$width?>, "400", "9.0.0", "expressInstall.swf",
    {"data-file":"chart-capacity.php?param= <? echo $row_series[0] ?> |<? echo $start_date ?>|<? echo $end_date ?>"} );
    </script> 
      <INPUT TYPE=BUTTON OnClick="OFC.jquery.rasterize('my_chart<?echo preg_replace('/\s/', '',$row_series[0]) ?>', 'my_chart<?echo preg_replace('/\s/', '',$row_series[0]) ?>');" VALUE="SAVE"> 
  </td>

<td style="margin-bottom:10px;padding:10px;vertical-align:top;">
<table border=1 cellpadding=6 cellspacing=0 align="center" >
<tr>
<td colspan=2><span class="labeltext"><p align="center"><font color='#F24062'><?=$m_series?></font></p></font></td>
</tr>
<tr>
<td><span class="tabletext"><p align="left">No. of Machines</p></font></td>
<td><span class="tabletext"><?php echo $count?></td>
</tr>
<tr>
