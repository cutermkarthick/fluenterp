...
open_flash_chart_object( 450, 200, 'http://'. $_SERVER['SERVER_NAME'] .'/fluentwms/pie_chart_prodn.php?setting_time='.$total_setting_time.'&idle_time='.$total_idle_time.'&breakdown_time='.$total_breakdown_time.'&running_time='.$total_running_time.'&machine=BMV 60-1',false );
?>
</table>
...
<td id="chart$tblid">
 <?php
      include_once 'ofc-library/open_flash_chart_object.php';
      $mc=urlencode('BMV 1');
      open_flash_chart_object( '400%', 350, 'http://'. $_SERVER['SERVER_NAME'] .'/fluentwms/chart-prodneff1.php?mcname='.$mc.'&sdate='.$fromdate1.'&edate='.$todate1, false );
...
<td id="chartst$tblid">
 <?php
      include_once 'ofc-library/open_flash_chart_object.php';
      $mc=urlencode('BMV 1');
      open_flash_chart_object( 990, 350, 'http://'. $_SERVER['SERVER_NAME'] .'/fluentwms/chart-eststeff1.php?mcname='.$mc.'&sdate='.$fromdate1.'&edate='.$todate1, false );
...
<td id="chartrt$tblid">
 <?php
      include_once 'ofc-library/open_flash_chart_object.php';
      $mc=urlencode('BMV 1');
      open_flash_chart_object( 990, 350, 'http://'. $_SERVER['SERVER_NAME'] .'/fluentwms/chart-estrteff1.php?mcname='.$mc.'&sdate='.$fromdate1.'&edate='.$todate1, false );
...
<?php
include_once 'ofc-library/open_flash_chart_object.php';
open_flash_chart_object( 450, 200, 'http://'. $_SERVER['SERVER_NAME'] .'/fluentwms/pie_chart_prodn.php?setting_time='.$total_setting_time.'&idle_time='.$total_idle_time.'&breakdown_time='.$total_breakdown_time.'&running_time='.$total_running_time.'&machine=BMV 1',false );
?>
</table>
...
<?php
include_once 'ofc-library/open_flash_chart_object.php';
open_flash_chart_object( 450, 200, 'http://'. $_SERVER['SERVER_NAME'] .'/fluentwms/pie_chart_prodn.php?setting_time='.$total_setting_time.'&idle_time='.$total_idle_time.'&breakdown_time='.$total_breakdown_time.'&running_time='.$total_running_time.'&machine=BMV 60-2',false );
?>
</table>
</div>
</td> -->
...
<td id="chartbmv602">
 <?php
      include_once 'ofc-library/open_flash_chart_object.php';
      $mc=urlencode('DMG 3');
      open_flash_chart_object( 990, 350, 'http://'. $_SERVER['SERVER_NAME'] .'/fluentwms/chart-prodneff1.php?mcname='.$mc.'&sdate='.$fromdate1.'&edate='.$todate1, false );
