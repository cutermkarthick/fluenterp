...
<?php
 ...
 $result_disputd = $newassywo->getdisputd4treat($myrow[0],$myrow[5]);
         while($myrow_disp =  mysql_fetch_row($result_disputd))
         {
          ...
          ?>
    <tr bgcolor="#FFFFFF"><td bgcolor="#FFFFFF" width=6px><input type="radio" name="wo4assy"   id="wo4assy" value="<?php echo $myrow[0]."|".$myrow[3]."|".$dncofcdets."|".$myrow_disp[15]."|".$avail_qty?>"></td>
