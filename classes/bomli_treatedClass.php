...
class bomli_treat_items {
    ...
    function addLi() {
        ...
        $sql = "select nxtnum from seqnum where tablename = 'bom_treated_items' for update";
        $result = mysql_query($sql);
        if(!$result) {
           $sql = "rollback";
           $result = mysql_query($sql);
        ...
        $sql = "INSERT INTO bom_treated_items (recnum, line_num, item_no, partnum, crn, partname,
        ...
        $sql = "update seqnum set nxtnum = $objid where tablename = 'bom_treated_items'";
        $result = mysql_query($sql);
...
function get_treated_li($inpbomrecnum)
 {
