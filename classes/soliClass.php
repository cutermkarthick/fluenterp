    ...
    function addQI() {
      ...
      /*  $sql = "select nxtnum from seqnum where tablename = 'so_line_items' for update";
       ...
       // $hcdrgiss = "'" . $this->hcdrgiss . "'";
        ...
        $dim2 =  "'" . $this->dim2 . "'";
        $dim3 =  "'" . $this->dim3 . "'";
        $sql = "INSERT INTO so_line_items (line_num, item_desc, qty, price,
                                           amount, link2so, partnum,rmtype, rmspec, 
                                           partiss, drgiss, rmprice, rmamount,
                                           mcprice,mcamount,po_cos,
                                           model_iss,uom, dia, length, width,
					   thickness, grainflow, maxruling, altspec,cos_iss,crn_num,`condition`,po_num,dim1,dim2,dim3)
                                    VALUES ($item_num, $item_desc, $qty,  $price,
                                            $amount, $link2so, $partnum, $rmtype, $rmspec,
                                            $partiss, $drgiss, $rmprice, $rmamount,
                                            $mcprice,$mcamount,$po_cos,
                                            $model_iss,	$uom, $dia, $length, $width,
					    $thickness, $gf, $maxruling, $altspec,$cos_iss,$crn_num,$condition,$ponum,$dim1,$dim2,$dim3)";
        // echo $sql; exit;
        $result = mysql_query($sql);
