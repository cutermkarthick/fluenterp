 ...
 function getrisk() {
    ...
    function getassyReviewSummary($cond)
    {
       ...
       $sql = " SELECT r.recnum as rec, company.name, '', r.po_date,
                             ...
                             '',aw.recnum as worec,rli.crn as crn,rli.line_num as ln,'','',aw.assy_wonum as wonum,rli.pcrn as pcrn,r.qa_approved,r.engineering_approved
                      ...
                      SELECT r.recnum as rec, company.name, '', r.po_date,
                             ...
                             '',aw.recnum as worec,rli.crn as crn,rli.line_num as ln,ali.qty_rej,ali.qty_ret,aw.assy_wonum as wonum,rli.pcrn as pcrn,r.qa_approved,r.engineering_approved
   ...
   function getrej_qty4assy($wonum)
     ...
     function getcrn4review()
     {
      ...
      $sql = "select crn,assy_partnum,bomnum,bom_revnum,title 
	           from bom where status='Active' and $siteval
	           order by bomnum ";
			// echo $sql;
      $result = mysql_query($sql);
