...
<?php
 ...
 ?>
         ...
         <?php
         include_once 'ofc-library/open_flash_chart_object.php';
          open_flash_chart_object( 450, 200, 'http://'. $_SERVER['SERVER_NAME'] .'/fluentwms/pie_chart_prodn.php?setting_time='.$total_setting_time.'&idle_time='.$total_idle_time.'&breakdown_time='.$total_breakdown_time.'&running_time='.$total_running_time.'&machine='.$mcname,false );
         ?>
		 </td>
		 </tr>
         </table>
...
<?
         ...
         $mc=urlencode($mcname);     
		  include_once 'ofc-library/open_flash_chart_object.php';
         open_flash_chart_object( 990, 350, 'http://'. $_SERVER['SERVER_NAME'] .'/fluentwms/chart-prodneff1.php?mcrypt_get_cipher_name(cipher)='.$mc.'&sdate='.$stdate.'&edate='.$enddate, false );
	    ...
	    include_once 'ofc-library/open_flash_chart_object.php';
	   open_flash_chart_object( 990, 350, 'http://'. $_SERVER['SERVER_NAME'] .'/fluentwms/chart-eststeff1.php?mcname='.$mc.'&sdate='.$stdate.'&edate='.$enddate, false );
	    echo "<table width=990px border=1 cellpadding=3 cellspacing=1 bgcolor=\"#DFDEDF\">";
         echo '<tr bgcolor="#FFFFFF">';
         echo '<td colspan=4 bgcolor="#FFFFFF" align="right"><span class="tabletext"><b>Machine Utilization Efficiency</b></td>';
      ...
      $mc=urlencode($mcname);  
	   ...
	   include_once 'ofc-library/open_flash_chart_object.php';
      open_flash_chart_object( 990, 350, 'http://'. $_SERVER['SERVER_NAME'] .'/fluentwms/chart-estrteff1.php?mcname='.$mc.'&sdate='.$stdate.'&edate='.$enddate, false );
       echo "<table width=990px border=1 cellpadding=3 cellspacing=1 bgcolor=\"#DFDEDF\">";
         echo '<tr bgcolor="#FFFFFF">';
         echo '<td colspan=4 bgcolor="#FFFFFF" align="right"><span class="tabletext"><b>Machine Utilization Efficiency</b></td>';
