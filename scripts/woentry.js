  ...
  while (x < max)
    {
        ...
        ncstat= "ncstat" +x;
        ncnum="ncnum"+x;
       if((document.getElementById('treatment').value=='Manufacture Only') ||
           (document.getElementById('treatment').value=='With Treatment' && document.getElementById('woclassif').value == 'Rework'))
       {
...
*/
       ...
       else if(document.getElementById('treatment').value=='With Treatment')
       {
...
if(document.getElementById('treatment').value=='Manufacture Only'||document.getElementById('treatment').value==''||document.getElementById('treatment').value=='null')
{
