   ...
   if(document.getElementById('pagename').value=='new_assywo')
{
    ...
    while(i<index)
    {
       ...
       if(document.getElementById("pagename").value=="edit_assywo" || document.getElementById("pagename").value== "new_assywo" && document.getElementById("dept").value!="QA")
       {
...
win1 = window.open("getpo4assywo.php?cim_refnum="+crn+"&partnum="+rt+"&woclassif="+'Assembly', param, +
"menubar=0,toolbar=0,resizable=1,scrollbars=1" +
",width=" + winWidth + ",height=" + winHeight +
",top="+winTop+",left="+winLeft);
}
...
function SetWo4assy(woarr,fieldname)
 {    //alert(woarr+"*******"+fieldname);
  ...
  if(data4wo[4] < parseInt(document.getElementById(id2).value))
  {
   ...
   document.getElementById(id4).value=data4wo[3];
