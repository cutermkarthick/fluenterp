...
<input type="text" size=15% name="prn_outlook" id="prn_outlook" value="<?php echo $prn_outlook ?>">
&nbsp;&nbsp;<span class="labeltext"><b>Trigger:</b>&nbsp;
<input type="text" size=15% name="ftrigger" id="ftrigger" value="<?echo $ftrigger; ?>">(ALL/RMPO/WO/TREAT)
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="button"><b> <img src="images/bu-get.gif" value="Get"
...
$countmaincrn = 0;
  ...
  $crntype=$newreport->getcrntype($prn_outlook);
    if($flag == 0)
    {
        $lobresult = $newreport->getlob1($prn_outlook,$crntype);
        }
