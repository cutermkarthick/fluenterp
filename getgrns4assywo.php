...
?>
    ...
    <tr bgcolor="#FFFFFF"><td bgcolor="#FFFFFF" width=4%><input type="radio" id="crn"  name="crn"   value="<?php echo $myrow[1] . "|" . $myrow[2] . "|" . $qty . "|" . $myrow[4]. "|" . $myrow[5]. "|" . $myrow[6]. "|" . $myrow[9]?>"></td>
                   ...
                   if($myrowli[17] =='')
                 {
                  ...
                  //echo"---------------<br>" .$total."----------------<br>".$myrowli[9];
                     ...
                     if ($qty > 0)
	                 {
						 ...
						 ?>
						 <tr bgcolor="#FFFFFF"><td bgcolor="#FFFFFF" width=4%><input type="radio" id="crn"  name="crn"   value="<?php echo $myrow[1] . "|" . $myrow[2] . "|" . $qty . "|" . $myrow[4]. "|" . $myrow[5]. "|" . $myrow[6]. "|" . $myrow[8]?>"></td>
	<td width=6% bgcolor="#FFFFFF"><span class="tabletext"><?php echo $myrow[1] ?></td>
    <td width=12%><span class="tabletext"><?php echo $myrow[2] ?></td>
    <td width=7%><span class="tabletext"><?php echo $qty ?></td>
    <td width=7%><span class="tabletext"><?php echo wordwrap($myrow[4],10,"<br>\n",true) ?></td>
