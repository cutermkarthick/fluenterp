...
<table class="stdtable1" style="width:100%"  border=0 cellpadding=3 cellspacing=1 bgcolor="#DFDEDF">
        ...
        <tr bgcolor="#FFFFFF">
            ...
            <td><span class="tabletext"><?php echo $myrow[53] ?></td>
            <td><span class="labeltext">Contact Person</font></td>
            <td><span class="tabletext"><?php echo $myrow[65] ?></td>
        </tr>

        <tr bgcolor="#FFFFFF">
            <td><span class="labeltext">Order Stored in the form of</td>
            <td><span class="tabletext"><?php echo $myrow[69] ?></td>
            <td><span class="labeltext">Filename/Path</font></td>
            <td><span class="tabletext"><?php echo $myrow[70] ?></td>
        </tr>
        ...
        <tr bgcolor="#FFFFFF">
            ...
            <td><span class="tabletext"><?php echo $myrow[51] ?></td>
        </tr>
...
<th class="head1" style="padding:5px 6px;width:26px;"><span class="heading"><b><center>CRN</center></b></td>
