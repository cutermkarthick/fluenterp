...
<td align="right">
<?php
//echo "Dept is $dept now";
if ($dept == 'Sales' || 
(($dept == 'PPC' || $dept == 'PPC4'||
$dept == 'PPC5') && $myrow[22] != 'Closed') && 
$myrow[22] != 'Hold')
{
// if($myrow[18] =='0000-00-00')
// {
?>
<input type="button" class="stdbtn btn_blue" style="float:right;padding:2px;margin-right:5px;" onClick="location.href='WodetailsEdit.php?worecnum=<?php echo $worecnum ?>'" value="Edit" >
<!-- <a href ="WodetailsEdit.php?worecnum=<?php echo $worecnum ?>" ><img name="Image8" border="0" src="images/bu-edit.gif" ></a> -->
<?php
//}

if ($dept == 'Sales' || ($myrow[46] == 0) || ($myrow[46] = 1 && $myrow[47] == 1))
{

echo '<input type="button" class="stdbtn btn_blue" style="float:right;padding:2px;margin-right:5px;" onClick="javascript: printwoDetails()" value="Print" >';
// echo '<img src="images/bu-print.gif" alt="Print BoardWO" onClick="javascript: printwoDetails()">';
}
?>
<input type="button" class="stdbtn btn_blue" style="float:right;padding:2px;margin-right:5px;" onClick="location.href='export_cimproc.php?worecnum=<?echo $_REQUEST['worecnum']?>&wonum=<?echo $_REQUEST['wonum']?>'" value="Export" >
<!--<img src="images/bu-print.gif" alt="Print BoardWO" onClick="javascript: printwoDetails()">-->
<!-- <a href="export_cimproc.php?worecnum=<?echo $_REQUEST['worecnum']?>&wonum=<?echo $_REQUEST['wonum']?>"><img name="Image8" border="0" src="images/export.gif" ></a> -->
<?php
}
if ($dept == 'QA' && $myrow[22] != 'Hold' && $myrow[22] != 'Closed')
{
?> 
<input type="button" class="stdbtn btn_blue" style="float:right;padding:2px;margin-right:5px;" onClick="location.href='WodetailsEdit.php?worecnum=<?php echo $worecnum ?>'" value="Edit" >
<?php
}
if($myrow[30] == 'Rework' && $dept =='Purchasing' && $userrole=='SU')
{
?>
<input type="button" class="stdbtn btn_blue" style="float:right;padding:2px;margin-right:5px;" onClick="location.href='WodetailsEdit.php?worecnum=<?php echo $worecnum ?>'" value="Edit" >
<?php
...
//echo $wonum."-*-*-*-".$myrow[0];
echo  " <tr bgcolor=\"#DDDEDD\"><td colspan=6><span class=\"heading\"><center><b>Work Order Information</b></center></td></tr>
	<tr bgcolor=\"#FFFFFF\">
	<td ><span class=\"tabletext\"><b>Work Order</b></td>
	<td  ><span class=\"tabletext\"><b>";

printf("%05d%s",$myrow[0],$wonum_suf);
...
if($myrow[57] != '0000-00-00' && $myrow[57] != '' && $myrow[57] != 'NULL')
{
$datearr2 = split('-', $myrow[57]);
$month1=$datearr2[1];
$year1=$datearr2[0];
$day1=$datearr2[2];
$app_date=$months[$month1-1].' '.$day1.','.$year1;
}
//echo $myrow[55]."----";
echo "</b></td>
<td ><span class=\"tabletext\"><b>Work Order Qty</b></td>
<td colspan=3><span class=\"tabletext\">$woqty</td>
</tr>
<tr  bgcolor=\"#FFFFFF\">
<td><span class=\"tabletext\"><b>Work Order Type</b></td>
<td colspan=6><span class=\"tabletext\">$myrow[30]</td>

</tr>";
if($myrow[30]=='Split')
{
echo"<tr  bgcolor=\"#FFFFFF\">
<td><span class=\"tabletext\"><b>Stage(Split)</b></td>
<td colspan=6><span class=\"tabletext\">$myrow[43]</td>
</tr>";
}
echo"<tr bgcolor=\"#FFFFFF\">
<td><span class=\"tabletext\"><b>Work Order Date</b></td>
<td ><span class=\"tabletext\">$date1</td>
<td ><span class=\"tabletext\"><b>Work Order Ref#</b></td>
<td colspan=4><span class=\"tabletext\">$myrow[31]</td>
</tr>
<tr bgcolor=\"#FFFFFF\">
<td><span class=\"tabletext\"><b>Work Order Priority</b></td>
<td bgcolor=\"$bcolor\"><span class=\"tabletext\">$myrow[54]</td>
<td><span class=\"tabletext\"><b>Work Order Status</b></td>
<td colspan=4><span class=\"tabletext\">$myrow[22]</td>
</tr>
<tr bgcolor=\"#FFFFFF\">
<td><span class=\"labeltext\"><b>Approved </b></td>
<td><span class=\"tabletext\"> $myrow[56]  </td>
<td><span class=\"labeltext\"><b>Approved By & Date </b></font></td>
<td colspan=4><span class=\"tabletext\">$myrow[55],$app_date</td>
</tr>

<tr bgcolor=\"#DDDEDD\"><td colspan=6><span class=\"heading\"><center><b>General Information</b></center></td></tr>
...
<td colspan=4><span class=\"tabletext\">$myrow[3]</td>
...
<td colspan=4><span class=\"tabletext\">$myrow[28]</td>
...
<tr  bgcolor=\"#FFFFFF\">
<td><span class=\"tabletext\"><b>RM Spec</b></td>
<td><span class=\"tabletext\">$myrow[48]</td>
<td colspan=2><span class=\"tabletext\"><b>RM Type</b></td>
<td colspan=2><span class=\"tabletext\">$myrow[49]</td>
</tr>
...
<td colspan=2><span class=\"tabletext\">$amenddate</td>
</tr>
<tr  bgcolor=\"#FFFFFF\">
<td><span class=\"tabletext\"><b>Type</b></td>
<td><span class=\"tabletext\">$myrow[41]</td>
<td colspan=2></td>
<td colspan=2></td>
</tr>
<tr  bgcolor=\"#FFFFFF\">                        
...
<table border=0 bgcolor="#DFDEDF" width=100% cellspacing=1 cellpadding=4 class="stdtable1">
...
printf('<tr bgcolor="#FFFFFF"><td colspan=12><textarea name="notes" rows="6" cols="89" readonly="readonly">');
...
<tr class='bgcolor4'>
<td colspan=20><span class="heading"><center><b>Timeline & Owner</b></center></td>
</tr>
<tr><td colspan=13>
<table width=100% border=0 cellspacing=1 cellpadding=4 bgcolor="#DFDEDF" class="stdtable1">
...
<td><span class="tabletext"><p align="left"><b>Pending Sch Qty</b></p></font></td>
<td><input type="text" name="sch_due_qty"
style="background-color:#DDDDDD;"
readonly="readonly" size=12 value="<?= $myrow[58] ?>"></td>
...
<?
if($date3 != '0000-00-00' && $date3 !='' && ($dept == 'PPC5' || $dept == 'Sales'))
{
$result=$newdli->getcofc_lineitems($myrow[0]);
if(mysql_num_rows($result) == 0)
{?>
<a href ="processcofc.php?worecnum=<?php echo $worecnum ?>" ><img name="Image8" border="0" src="images/create_cofc.gif" ></a>
<?
}
else
{
$row=mysql_fetch_array($result);
$cofc_num=$row['relnotenum'];
echo "<span class='labeltext'><font color='green'>Cofc:$cofc_num</font>";
}
}?>
</td>
<?php
...
<!--        <td><a href ="javascript:displayShipment()"><?php // echo $link?></a>
	...
	<tr class='bgcolor4' WIDTH="100%">
		...
		<td width=11%><span class="heading"><b><center>Processy</center></b></td>
		<td width=20%><span class="heading"><b><center>When will<br>Done</center></b></td>
	...
	while ($mytl = mysql_fetch_row($timeline)) 
	{
        ...
        <?php echo $mytl[28];
			...
			<td width=9%><span class="heading"><?php if ($mytl[2] != '0000-00-00') echo $date1 ?></span></td>


			<td width=9%><span class="heading"><?php if ($mytl[4] != '0000-00-00') echo $date3 ?></span></td>

			<?php
			if ($mytl[10] != 'Cust') 
			{
			?>
			<td WIDTH=9%><span class="heading"><?php echo $mytl[12] ?></span></td>
			<?php
			}
			else 
			{
			?>
			<td WIDTH=9%><span class="heading"><?php echo $mytl[14] ?></span></td>
			<?php
			}
			if ($mytl[10] != 'Cust' && $myrow[22] != 'Hold') 
			{
			?>
			<td width=11%><span class="heading">
			<?php
			if(($mytl[29] == '' && $mytl[16] == '' && $userrole == 'SU' && $dept=='Sales') || ($mytl[29] == '' && $mytl[16] == '' && $userrole == 'RU' && $mytl[28] == $dept && $mytl[28] !='Purchasing')) 
			{
			?>
   		...
   		else if($mytl[29] == '' && $mytl[16] == '' && $userrole == 'SU' && ($dept=='PPC') && ($mytl[31]=='240' || $mytl[31]=='270' || $mytl[31] == '280')) 
     	{
			?>
				<a href="processApproval.php?worecnum=<?php echo $worecnum ?>&wfrecnum=<?php echo $mytl[9] ?>&drecnum=<?php echo $mytl[8] ?>&typerecnum=<?php echo $typenum ?>&nextstatus=<?php echo $mytl[30] ?>&stagenum=<?php echo $mytl[31] ?>">
				<img src="images/bu_approval.gif" border=0>  
   		...
   		else if($mytl[29] == '' && $mytl[16] == '' && $userrole == 'OP' && ($dept=='PPC4'||$dept=='PPC5') && ($mytl[31]=='240' || $mytl[31]=='270' || $mytl[31] == '280')) 
     	{
			?>
				<a href="processApproval.php?worecnum=<?php echo $worecnum ?>&wfrecnum=<?php echo $mytl[9] ?>&drecnum=<?php echo $mytl[8] ?>&typerecnum=<?php echo $typenum ?>&nextstatus=<?php echo $mytl[30] ?>&stagenum=<?php echo $mytl[31] ?>">
				<img src="images/bu_approval.gif" border=0>  
			...
			else if($mytl[29] == '' && $mytl[16] == '' && $userrole == 'RU' && ($dept=='PPC6') && ($mytl[31]=='270')) 
			{
			?>
			<a href="processApproval.php?worecnum=<?php echo $worecnum ?>&wfrecnum=<?php echo $mytl[9] ?>&drecnum=<?php echo $mytl[8] ?>&typerecnum=<?php echo $typenum ?>&nextstatus=<?php echo $mytl[30] ?>&stagenum=<?php echo $mytl[31] ?>">
			<img src="images/bu_approval.gif" border=0>  
   		...
   		else if($mytl[29] == '' && $mytl[16] == '' && ($userrole == 'RU' ||$userrole == 'OP')&& $mytl[28] != $mytl[33])
			{
			?>
			<img src="images/bu_approval.gif" border=0>
			<?php
  		}
    	else if($mytl[29] == '' && $mytl[16] == '' && $userrole == 'SU' && $mytl[28] != $mytl[33])
			{
			?>
			<img src="images/bu_approval.gif" border=0>
			<?php
			...
			<td width=4%><span class="heading"><?php echo $mytl[35] ?></td>

			<td width=4%><span class="heading"><?php echo $mytl[36] ?></td>

			<td width=4%><span class="heading"><?php echo $mytl[37] ?></td>
...
<input type="hidden" name="pagename" id="pagename" size=15 value="woDetails">
</table>
</td>
<!-- <td width="6"><img src="images/spacer.gif " width="6"></td>
</tr>
