...
<input type="hidden" name="cust_po_line_num" id="cust_po_line_num" value=""></td>
	...
	<tr bgcolor="#FFFFFF">
       ...
       <td><span class="labeltext">
           ...
           <td><input type="text" id="date"  name="amenddate" style="background-color:#DDDDDD;" readonly="readonly"
		...
		<td><textarea id="amendnotes" name="amendnotes" rows="2"
			              style=";background-color:#FFFFF;"
   ...
   <table border=0 width=100% cellspacing=1 cellpadding=3 class="stdtable1">
    ...
    <tr  bgcolor="#FFFFFF">
          ...
          <td bgcolor="#EEEFEE"><span class="heading"><b><center>Process</center></b></td>
	        <td bgcolor="#EEEFEE"><span class="heading"><b><center>When will <br> Done</center></b></td>
       </tr>
...
?>
          ...
          <tr bgcolor="#FFFFFF">
            ...
            <td><input type="text" name="<?php echo $dates ?>" style="background-color:#DDDDDD;" readonly="readonly" size=10 value="">
...
?>        
          <td><input type="text" name="<?php echo $dates ?>" style="background-color:#DDDDDD;" readonly="readonly" size=10 value="<?php echo $myrow[11] ?>">
          </td>

          <td><input type="text" name="<?php echo $dates ?>" style="background-color:#DDDDDD;" readonly="readonly" size=10 value="<?php echo $myrow[12] ?>" >
          </td>

          <td><input type="text" name="<?php echo $dates ?>" style="background-color:#DDDDDD;" readonly="readonly" size=10 value="<?php echo $myrow[13] ?>">
          </td>
