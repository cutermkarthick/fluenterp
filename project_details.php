		...
		?>
            ...
            <input type="hidden" name="recnum" value="<?php echo $recnum; ?>">
						...
						<table width=100% align='center' border=1 cellpadding=4 cellspacing=1 bgcolor="#DFDEDF" class="stdtable">
							<thead>
								<tr bgcolor="#FFFFFF">
									...
									<td class="head0"><span class="heading"><b>Est Time<br>(HH:MM)</b></td>
									<td class="head0"><span class="heading"><b>Category</b></td>
									<td class="head0"><span class="heading"><b>Task Accepted <br>Date</b></td>
									<td class="head0"><span class="heading"><b>Task Completed <br>Date</b></td>
									<td class="head0" style="width:70px !important;"><span class="heading"><b>Actual Time<br>HH:MM</b></td>
				        ...
				        $totalsecs = $totalsec_mins;
								...
								// if($usertype =='host')
								// {	
								// 	echo"<td bgcolor=\"#FFFFFF\"><span class=\"tabletext\"><a href=\"task_Edit.php?recnum=$myLI[0]&link2project=$recnum&project=$myrow[1]\">$myLI[1]</td>" ;
								// }
								// else
								// {	
								...
								echo"<td bgcolor=\"#FFFFFF\"><span class=\"tabletext\">$task_wo_hrs</td>";  
