...
<td><input type="text" name="finish_date" id="finish_date" size=15 value="<?echo $myrow[8]?>" readonly="readonly" style="background-color:##DDDDDD"><img src="images/bu-getdateicon.gif" alt="Get Date"  onclick="GetDate('closed_date')"></td>
</tr>
