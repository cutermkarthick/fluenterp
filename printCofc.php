...
<table width=100%>
<tr>
    <td><img src="images/fsi_logo.png" alt="CIM Tools" width="137" height="35" class="Masthead" /></td>
<tr>
...
{
?>
<tr><td><span class="labeltext">Date : <span class="tabletext"><?php echo $dispdate ?></td></tr>
<?php
}
else
{
...
<table width=100% border=1 cellspacing=0 cellpadding=4 rules="all">
       <tr bordercolor=#777777>
            ...
            <td align="center" width=4%><span class="tabletext"><b>WO No.</b></td>
...
*/
            ...
            if($myLI['disp_custpo_no']!='' && $myLI['disp_custpo_item']!='')
			{
			 $custpo= $myLI['disp_custpo_no'];
			 $itemnum = $myLI["disp_custpo_item"];
			}else
			{
             $custpo = $custponum;
...
{
?>
Certified that the whole of the supplies detailed herein have been<br>
manufactured, tested and inspected and unless otherwise stated above, conform to the<br>
relevant specifications, drawings, and contract/order.<br>
<?php
}
else
{
...
{
?>
<tr><td colspan=2 align=right><span class="heading">PRN #: <?php echo $myrow[10] ?></td></tr>
<?php
}
else
{
...
<tr class="bgcolor2" bordercolor="#CCCCCC">
            <td colspan=2><span class="labeltext">F4200</td>
            <td colspan=4><span class="fmttext">Rev Dt OCt 3, 2016; New format</td>
            <td colspan=11><span class="labeltext">Fluent Technologies</td>
</tr>
</table>
<br>
